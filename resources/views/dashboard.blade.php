...
<head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="{{ asset('plus') }}/assets/images/favicon.png" />
</head>
                ...
                <div class="container">
                    <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                        <a class="navbar-brand brand-logo" href="index.html">
                            <img src="{{ asset('plus') }}/assets/images/logo.svg" alt="logo" />
                            <span class="font-12 d-block font-weight-light">Responsive Dashboard </span>
                        </a>
                        <a class="navbar-brand brand-logo-mini" href="index.html"><img
                                src="{{ asset('plus') }}/assets/images/logo-mini.svg" alt="logo" /></a>
                    </div>
            ...
            <nav class="bottom-navbar">
                <div class="container">
                    <ul class="nav page-navigation">
                        ...
                        <li class="nav-item">
                            <a href="https://www.bootstrapdash.com/demo/plus-free/documentation/documentation.html"
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100"
                                        src="{{ asset('plus') }}/assets/images/dashboard/img_1.jpg" alt="" />
                                </div>
                        ...
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid w-100"
                                        src="{{ asset('plus') }}/assets/images/dashboard/img_2.jpg" alt="" />
                                </div>
                                <div class="card-body px-3 text-dark">
                                    <div class="d-flex justify-content-between">
                                        <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
                        ...
                        <div class="col-sm-4 stretch-card grid-margin">
                            <div class="card">
                                <div class="card-body p-0">
                                    <img class="img-fluid"
                                        src="{{ asset('plus') }}/assets/images/dashboard/img_3.jpg" alt="" />
                                </div>
                                <div class="card-body px-3 text-dark">
                                    <div class="d-flex justify-content-between">
                                        <p class="text-muted font-13 mb-0">ENTIRE APARTMENT</p>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table custom-table text-dark">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('plus') }}/assets/images/faces/face2.jpg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('plus') }}/assets/images/faces/face3.jpg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('plus') }}/assets/images/faces/face4.jpg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('plus') }}/assets/images/faces/face5.jpg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('plus') }}/assets/images/faces/face7.jpg"
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="{{ asset('plus') }}/assets/images/faces/face9.jpg"
                            ...
                            <div class="card color-card-wrapper">
                                <div class="card-body">
                                    <img class="img-fluid card-top-img w-100"
                                        src="{{ asset('plus') }}/assets/images/dashboard/img_5.jpg" alt="" />
